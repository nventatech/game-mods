...
- Info panel that explains every option, ten color themes, settings backup and restore, icons on every tab and section, status window with level, cred, eddies and points
...
- Aim assist (hold, toggle, ADS, while shooting or always), NPC ESP through walls, loot markers by tier, stat lock
- Noclip, kill hostiles nearby, effects on the NPC you aim at (burn, shock, ally...), damage taken slider, hide HUD, FOV, attributes -/+, perks one by one
...
- Loot filter: block junk by category and tier, up to 5++, delete or disassemble it
- Loadouts: save and re-equip weapons, clothes and cyberware
- Vendors: restock one, all, or on every visit
- Achievements one by one or all at once
...
- Vehicle light colour and brightness, rainbow lights, infinite missiles, no gun overheat, flip or unstick, instant enter
- God mode, XP/damage/eddies multipliers, cyberware duration and slow-mo sliders, quickhack/run speed/crafting tweaks, extra cyberware capacity, level cap slider up to 100, unlocks
...
Requires [Cyber Engine Tweaks](https://www.nexusmods.com/cyberpunk2077/mods/107) and [Codeware](https://www.nexusmods.com/cyberpunk2077/mods/7780) (which brings RED4ext and redscript). [TweakXL](https://www.nexusmods.com/cyberpunk2077/mods/4197) is needed by the cyberware capacity slider and levels past 60 (one yaml in the zip). The zip has `bin/` and `r6/` folders; copy both.
